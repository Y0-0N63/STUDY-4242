...
//[문제 2] 입력받은 숫자(개수) 만큼의 숫자를 저장할 배열을 생성하고
//[문제 3] 오름차순을 적용하여 출력하는 프로그램입니다.
...
public class CorrectAscendingOrder {
    public static void main(String[] args) {
        ...
        for(int i=0;i<num;i++){
            ...
            number[i]=sc.nextInt(); //배열 number의 i번째 요소로 저장하기
        }

        //[문제 3] 배열 내 숫자들을 오름차순으로 정렬하는 부분입니다. 주석을 참고하여 빈 줄을 채워주세요.
        for(int i=0;i<num-1;i++){
            //num-1인 이유는 마지막 순서에서는 이미 가장 큰 값이 정렬되어 있기 때문입니다.
            for(int j=0;j<num-1-i;j++){
            //[3-1]배열의 j번째 숫자와 j+1번째 숫자를 비교하여 가장 큰 숫자가 마지막 순서로 이동할 수 있도록 하는 부분입니다.
