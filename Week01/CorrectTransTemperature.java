...
public class CorrectTransTemperature {
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if(fc.equals("F")) {
                System.out.println("화씨 온도를 섭씨 온도로 변환합니다.");
                System.out.print("화씨 온도를 입력하세요.>>");
                double fahrenheit=sc.nextDouble();
                double fahrenheitToCelsius=(fahrenheit-32)*5/9;
                System.out.println("화씨 온도는 "+fahrenheitToCelsius+"입니다.");
            }
            else if (fc.equals("C")) {
                System.out.println("섭씨 온도를 화씨 온도로 변환합니다.");
                System.out.print("섭씨 온도를 입력하세요.>>");
                double celsius=sc.nextDouble();
                double celsiusToFahrenheit=(celsius*9/5)+32;
                System.out.println("섭씨 온도는 "+celsiusToFahrenheit+"입니다.");
            }
            else {
